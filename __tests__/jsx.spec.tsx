...
describe('Transform JSX', () => {
  ...
  test('Merge class', () => {
    ...
    // DIFFERENT: vue-jsx-runtime can not merge props
    // expect(wrapper.classes().sort()).toEqual(['a', 'b'].sort())
    expect(wrapper.classes().sort()).toEqual(['b'].sort())
  })
  ...
  test('Spread (mixed)', async () => {
    ...
    expect(calls).toEqual(expect.arrayContaining([4]))
  })
})
